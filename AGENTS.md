...
This file is the quick-reference operating contract for ed25519-dalek-kotlin. The longer
...
ed25519-dalek-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`ed25519-dalek`](https://crates.io/crates/ed25519-dalek). Upstream Rust is the behavioral oracle while the
