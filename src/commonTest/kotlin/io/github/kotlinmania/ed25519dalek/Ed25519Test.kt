...
class Ed25519Test {
    companion object {
        ...
        val EIGHT_TORSION_4: ByteArray = byteArrayOf(
            236.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(),
            255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(),
            255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(),
            255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 255.toByte(), 127.toByte(),
        )

        internal val WEAK_PUBKEY: CompressedEdwardsY = CompressedEdwardsY(EIGHT_TORSION_4)

        val PUBLIC_KEY_BYTES: ByteArray = byteArrayOf(
            130.toByte(), 39.toByte(), 155.toByte(), 15.toByte(), 62.toByte(), 76.toByte(), 188.toByte(), 63.toByte(),
            124.toByte(), 122.toByte(), 26.toByte(), 251.toByte(), 233.toByte(), 253.toByte(), 225.toByte(), 220.toByte(),
            14.toByte(), 41.toByte(), 166.toByte(), 120.toByte(), 108.toByte(), 35.toByte(), 254.toByte(), 77.toByte(),
            160.toByte(), 83.toByte(), 172.toByte(), 58.toByte(), 219.toByte(), 42.toByte(), 86.toByte(), 120.toByte(),
        )

        val SECRET_KEY_BYTES: ByteArray = byteArrayOf(
            62.toByte(), 70.toByte(), 27.toByte(), 163.toByte(), 92.toByte(), 182.toByte(), 11.toByte(), 3.toByte(),
            77.toByte(), 234.toByte(), 98.toByte(), 4.toByte(), 11.toByte(), 127.toByte(), 79.toByte(), 228.toByte(),
            243.toByte(), 187.toByte(), 150.toByte(), 73.toByte(), 201.toByte(), 137.toByte(), 76.toByte(), 22.toByte(),
            85.toByte(), 251.toByte(), 152.toByte(), 2.toByte(), 241.toByte(), 42.toByte(), 72.toByte(), 54.toByte(),
        )

        val SIGNATURE_BYTES: ByteArray = byteArrayOf(
            10.toByte(), 126.toByte(), 151.toByte(), 143.toByte(), 157.toByte(), 64.toByte(), 47.toByte(), 1.toByte(),
            196.toByte(), 140.toByte(), 179.toByte(), 58.toByte(), 226.toByte(), 152.toByte(), 18.toByte(), 102.toByte(),
            160.toByte(), 123.toByte(), 80.toByte(), 16.toByte(), 210.toByte(), 86.toByte(), 196.toByte(), 28.toByte(),
            53.toByte(), 231.toByte(), 12.toByte(), 157.toByte(), 169.toByte(), 19.toByte(), 158.toByte(), 63.toByte(),
            45.toByte(), 154.toByte(), 238.toByte(), 7.toByte(), 53.toByte(), 185.toByte(), 227.toByte(), 229.toByte(),
            79.toByte(), 108.toByte(), 213.toByte(), 80.toByte(), 124.toByte(), 252.toByte(), 84.toByte(), 167.toByte(),
            216.toByte(), 85.toByte(), 134.toByte(), 144.toByte(), 129.toByte(), 149.toByte(), 41.toByte(), 81.toByte(),
            63.toByte(), 120.toByte(), 126.toByte(), 100.toByte(), 92.toByte(), 59.toByte(), 50.toByte(), 11.toByte(),
        )
    }
