...
kotlin {
    ...
    val xcf = XCFramework("Ed25519Dalek")

    // Apple desktop
    macosArm64 {
        binaries.framework { baseName = "Ed25519Dalek"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Ed25519Dalek"
        flattenPackage = "io.github.kotlinmania.ed25519dalek"
    }

    android {
        namespace = "io.github.kotlinmania.ed25519dalek"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "ed25519-dalek-kotlin", version.toString())

    pom {
        name.set("ed25519-dalek-kotlin")
        description.set("Kotlin Multiplatform port of dalek-cryptography/curve25519-dalek - Fast and efficient ed25519 EdDSA key generations, signing, and verification in pure Rust")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/ed25519-dalek-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/ed25519-dalek-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/ed25519-dalek-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/ed25519-dalek-kotlin.git")
        }
    }
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    val sentinelFile = layout.buildDirectory.file("generated/codeql-empty/CodeqlEmptySourceSentinel.kt")
    ...
    doFirst {
        ...
        val compileSources =
            if (sourceFiles.isEmpty()) {
                val sentinel = sentinelFile.get().asFile
